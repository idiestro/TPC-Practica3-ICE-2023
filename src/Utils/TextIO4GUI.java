...
public class TextIO4GUI {
    ...
    */
	...
	private static Console console;  // The GUI IO widget used for simulated input/output.
	 ...
	 static String name;
	   ...
	   public TextIO4GUI(String _name) {
   ...
   private  static BufferedReader standardInput;  // wraps the input stream from Console. (Set in static initializer.)
   private  static PrintWriter standardOutput;  // wraps the output stream. (Set in static initializer.)
